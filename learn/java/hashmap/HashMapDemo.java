...
public class HashMapDemo {
    ...
    public static void main(String[] args) {
        ...
        stockPrice.putIfAbsent("Oracle", 70); // Inserting share price of Oracle again using putIfAbsent() method. This
        ...
        // Since Google is not present in our Map, this will return it with default
        // value of 100.
